...
<body>
	...
	<div class="container">
		...
		<div class="menu-list">
			...
			<a id="a5" href="#" onclick="myFunction(document.getElementById(this.id))">Bookings Details</a>
		...
		<div class="btn-tag" id="book-op">
				<button type="button" id="v5" onclick="showDetails(document.getElementById(this.id))">view Booking details</button>
				<!-- <button type="button" id="i3" onclick="insertMenu(document.getElementById(this.id))">Insert hotel</button>
				<button type="button" id="b4" onclick="deleteMenu(document.getElementById(this.id))">Delete hotel</button> -->
			</div>
			<div id="booking-container" style="display: none; margin-top: 50px;">
				<table align="center" border="1px" style="width: 500px; line-height: 30px;">
					<tr>
				...
				<div class="insert-form" id="ins-form3">
				<form method="POST" action="admin_op.php">     
					<input type="text" name="id" placeholder="Booking ID" required><br>
					<input type="submit" value="Confirm Booking" class="submit" name="confirm-booking">
				</form>
			</div>
			</div>
